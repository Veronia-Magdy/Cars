<?php
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        $gender = $_POST["gender"];
        try{
            $sql = "INSERT INTO `user`(`fullname`, `password`, `email`, `gender`) VALUES (?, ?, ?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->execute([$fullname, $pass, $email, $gender]);
  ...
  <body>
    <div class="main-block">
      ...
      <form action="" method= "POST">
        ...
        <hr>
        <div class="gender">
          <input type="radio" value="noun" id="male" name="gender" checked/>
          <label for="male" class="radio">Male</label>
          <input type="radio" value="noun" id="female" name="gender" />
